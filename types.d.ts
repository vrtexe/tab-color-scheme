...
declare namespace browser.browserAction {
   ...
   */
  const onUserSettingsChanged: WebExtEvent<
    (change: browser.action._GetUserSettingsReturnUserSettings) => void
  >;
}
...
declare namespace browser.declarativeNetRequest {
  ...
  function getDisabledRuleIds(
    options?: _GetDisabledRuleIdsOptions,
  ): Promise<number[]>;
...
declare namespace browser.permissions {
  ...
  interface Permissions {
    permissions?:
      ...
      | _manifest.OptionalOnlyPermission[]
      | undefined;
...
declare namespace browser.runtime {
   ...
   */
  const onPerformanceWarning: WebExtEvent<
    (details: _OnPerformanceWarningDetails) => void
  >;
}
...
declare namespace browser.scripting {
  ...
  function executeScript<T extends any[]>(
...
declare namespace browser.userScripts {
  ...
  interface _UpdateRegisteredUserScript extends Omit<
  ...
  ): Promise<_LegacyRegisteredUserScript>;
...
declare namespace browser.tabGroups {
  ...
  function move(
    groupId: number,
    moveProperties: _MoveProperties,
  ): Promise<TabGroup>;
  ...
  const onRemoved: WebExtEvent<
    (group: TabGroup, removeInfo: _RemoveInfo) => void
  >;
